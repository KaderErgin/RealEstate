...
namespace RealEstate_Dapper_UI.ViewComponents.Dashboard
{
    public class _DashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        {
            #region Statistics1-ToplamIlanSayisi
            ...
            #region Statistics2-EnBasariliPersonel
            var client2 = _httpClientFactory.CreateClient();
            var responseMessage2 = await client2.GetAsync("https://localhost:44333/api/Statistics/EmployeeNameByMaxProductCount");
            var jsonaDta2 = await responseMessage2.Content.ReadAsStringAsync();
            ViewBag.employeeNameByMaxProductCount = jsonaDta2;
            #endregion

            #region Statistics3 - IlandakiSehirSayilari
            ...
            #region Statistics4 - OrtalamaKiraFiyati
