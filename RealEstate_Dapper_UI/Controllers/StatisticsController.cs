...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var  jsonaData= await responseMessage.Content.ReadAsStringAsync();//veriyi string dondur
            ViewBag.activeCategoryCount = jsonaData;
            #endregion
            ...
            var jsonaDta11 = await responseMessage11.Content.ReadAsStringAsync();
            ViewBag.employeeNameByMaxProductCount = jsonaDta11;
            #endregion
            ...
            var jsonata14 = await responseMessage14.Content.ReadAsStringAsync();
            ViewBag.oldestBuildingYear = jsonata14;
            #endregion
