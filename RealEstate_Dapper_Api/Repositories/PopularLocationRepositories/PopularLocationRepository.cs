...
namespace RealEstate_Dapper_Api.Repositories.PopularLocationRepositories
{
    public class PopularLocationRepository : IPopularLocationRepository
    {
        ...
        public async Task<List<ResultPopularLocationDto>> GetAllPopularLocationde()
        {
        ...
        public async Task<GetByIDPopularLocationDto> GetPopularLocation(int id)
        {
            ...
            using (var connection = _context.CreateConnection())
            {
                var values = await connection.QueryFirstAsync<GetByIDPopularLocationDto>(query, parameters);//tek deger dondurecek
                return values;
            }
        }
